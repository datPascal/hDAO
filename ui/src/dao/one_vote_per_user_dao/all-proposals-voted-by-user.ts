...
export class AllProposalsVotedByUser extends LitElement {
  ...
  render() {
    ...
    return html`
      <div style="display: flex; flex-direction: column">
        ${this._records.map(r => 
          html`<proposal-vote-detail .actionHash=${r.signed_action.hashed.hash} style="margin-bottom: 16px;"></proposal-vote-detail>`
        )}
      </div>
    `;
  }
